...
--Create relationship between 'classificastion' and 'inventory' tables
...
--SQL code for testing queries

--Minor changes to the data for testing purposes
  UPDATE inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

--Query to replace file name
UPDATE inventory
